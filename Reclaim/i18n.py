...
_AR = {
    ...
    "⚠  Not admin — Update / Delivery Optimization / WER may be partly skipped.": "⚠  لست مسؤولاً — قد يُتخطّى جزء من تحديثات ويندوز / تحسين التسليم / تقارير الأخطاء.",
    ...
    "Finds byte-identical copies. Keeps one, sends the rest to the Recycle Bin (undoable).": "يجد النسخ المتطابقة تماماً، يُبقي نسخة واحدة ويرسل الباقي إلى سلة المحذوفات (قابل للتراجع).",
    "Lists files you haven't touched in a while. Relocate big files to another drive, "
    "or send them to the Recycle Bin (undoable).": "يسرد الملفات التي لم تستخدمها منذ مدة. انقل الكبيرة منها إلى قرص آخر، "
    ...
    "{drive}  —  {free} free of {total} ({pct}% used)": "{drive}  —  {free} متاح من أصل {total} (مستخدم {pct}%)",
    # Messageboxes — titles
    ...
    # Dialogs
    "Choose a destination folder (ideally on another drive)": "اختر مجلد وجهة (يُفضّل على قرص آخر)",
    "Preview — what would be removed": "معاينة — ما الذي سيُحذف",
    "Nothing is deleted here. This is exactly what 'Clean selected' would remove.": "لا يُحذف شيء هنا. هذا تماماً ما سيحذفه «تنظيف المحدد».",
    "(nothing found)": "(لا شيء)",
    "Cleanup history": "سجل التنظيف",
    "Clear history": "مسح السجل",
    "Language": "اللغة",
    "Custom folders to clean": "مجلدات مخصّصة للتنظيف",
    "Their contents are cleared like any cache. Added as the 'Custom folders' cleanup category.": "تُمسح محتوياتها كأي ذاكرة مؤقتة. تُضاف كفئة «مجلدات مخصّصة».",
    "Folders to exclude from scans": "مجلدات تُستثنى من الفحص",
    "Skipped by the Disk Analyzer, Duplicates and Old-files scans (and everything under them).": "تُتخطّى في فحوص محلّل القرص والمكرّرات والملفات القديمة (وكل ما بداخلها).",
    ...
    "User + Windows temp folders. Always safe to clear.": "مجلدات المؤقتات للمستخدم وويندوز. آمنة دائماً للمسح.",
    "Permanently empties the Recycle Bin.": "تُفرّغ سلة المحذوفات نهائياً.",
    "Chrome, Edge, Brave, Vivaldi, Opera & Firefox caches (all profiles). Logins kept.": "ذاكرة Chrome وEdge وBrave وVivaldi وOpera وFirefox (لكل الملفات الشخصية). تبقى تسجيلات الدخول.",
    "Discord, Spotify, Teams, Slack, Zoom & WhatsApp caches.": "ذاكرة Discord وSpotify وTeams وSlack وZoom وWhatsApp المؤقتة.",
    "npm, yarn, pnpm, pip, Gradle, Maven, NuGet, Cargo, Go & editor caches. Rebuilt on next build.": "ذاكرة npm وyarn وpnpm وpip وGradle وMaven وNuGet وCargo وGo والمحررات. يُعاد بناؤها لاحقاً.",
    "Old downloaded update files. Needs admin to clear fully.": "ملفات تحديث قديمة مُنزّلة. تحتاج صلاحيات مسؤول للمسح الكامل.",
    "Cached update-sharing data. Rebuilds automatically. Needs admin.": "بيانات مشاركة التحديثات المؤقتة. يُعاد بناؤها تلقائياً. تحتاج صلاحيات مسؤول.",
    "Windows Error Reporting archives & crash dumps.": "أرشيفات تقارير أخطاء ويندوز وتفريغات الأعطال.",
    "Kernel memory dumps & minidumps from past crashes. Needs admin.": "تفريغات ذاكرة النواة والتفريغات المصغّرة من أعطال سابقة. تحتاج صلاحيات مسؤول.",
    "CBS / DISM / setup logs. Regenerated as needed. Needs admin.": "سجلات CBS / DISM / الإعداد. يُعاد إنشاؤها عند الحاجة. تحتاج صلاحيات مسؤول.",
    "Explorer thumbnail/icon cache. Rebuilds automatically.": "ذاكرة الصور المصغّرة/الأيقونات في المستكشف. يُعاد بناؤها تلقائياً.",
    "Folders you've added under Settings. Their contents are cleared.": "مجلدات أضفتها من الإعدادات. تُمسح محتوياتها.",
    "Removes superseded update components via DISM. Needs admin; can take a while.": "يزيل مكوّنات التحديث المتجاوَزة عبر DISM. يحتاج صلاحيات مسؤول؛ قد يستغرق وقتاً.",
    "Deletes hiberfil.sys by turning hibernation off (also disables Fast Startup). Needs admin.": "يحذف hiberfil.sys بإيقاف الإسبات (يُعطّل أيضاً بدء التشغيل السريع). يحتاج صلاحيات مسؤول.",
    "Removes C:\\Windows.old left by a feature update. Needs admin; cannot be undone.": "يزيل C:\\Windows.old المتبقّي من تحديث ميزات. يحتاج صلاحيات مسؤول؛ لا يمكن التراجع.",
    # PySide6 UI: header control + live status/progress lines (templated)
    "Light mode": "الوضع الفاتح",
    "Dark mode": "الوضع الداكن",
    "Working…": "جارٍ العمل…",
    "Nothing removed — the selected files weren't found "
    "(in use, protected, or already gone).": "لم يُحذف شيء — لم يتم العثور على الملفات المحددة "
    ...
    "{n} files older than {m} months · {sz} total.": "{n} ملف أقدم من {m} شهراً · الإجمالي {sz}.",
    "Moved {n} duplicates to Recycle Bin · freed {sz}.": "نُقل {n} ملف مكرر إلى سلة المحذوفات · تم تحرير {sz}.",
    "Moved {n} files to Recycle Bin · freed {sz}.": "نُقل {n} ملف إلى سلة المحذوفات · تم تحرير {sz}.",
    "Moved {n} files · freed {sz}.": "نُقل {n} ملف · تم تحرير {sz}.",
    "Moved {n} of {total} files to {dest} · freed {sz} on the source drive.": "نُقل {n} من {total} ملف إلى {dest} · تم تحرير {sz} على القرص المصدر.",
    ...
    "Showing {shown} of {total} groups · {sz} reclaimable.": "عرض {shown} من {total} مجموعة · {sz} قابلة للاسترجاع.",
    # Crash dialog
    "Reclaim crashed": "توقف Reclaim عن العمل",
    "Something went wrong and Reclaim needs to close.\n\nDetails were saved to:\n{path}": "حدث خطأ ما ويجب إغلاق Reclaim.\n\nتم حفظ التفاصيل في:\n{path}",
    "(couldn't write a crash log)": "(تعذّر حفظ سجل العطل)",
}
