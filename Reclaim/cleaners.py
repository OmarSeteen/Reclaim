...
CLEANERS = [
    ...
    },
    {
        ...
        "kind": "dirs",
        "get": locations.browser_cache_dirs,
        "needs_admin": False,
    },
    {
        "key": "apps",
    ...
    },
    {
        ...
        "kind": "dirs",
        "get": locations.windows_update_dirs,
        "needs_admin": True,
    },
    {
        "key": "delivopt",
        ...
        "kind": "dirs",
        "get": locations.delivery_optimization_dirs,
        "needs_admin": True,
    },
    {
        "key": "wer",
        "label": "Error reporting dumps",
        "desc": "Windows Error Reporting archives & crash dumps.",
        "kind": "dirs",
        "get": locations.wer_dirs,
        "needs_admin": True,
    },
    {
        "key": "sysdumps",
        ...
        "kind": "files",
        "get": locations.system_dump_files,
        "needs_admin": True,
    },
    {
        "key": "winlogs",
        "label": "Windows servicing logs",
        "desc": "CBS / DISM / setup logs. Regenerated as needed. Needs admin.",
        "kind": "dirs",
        "get": locations.windows_log_dirs,
        "needs_admin": True,
    },
    {
        "key": "thumbs",
        ...
        "kind": "files",
        "get": locations.thumbnail_cache_files,
        "needs_admin": False,
    },
    {
        "key": "custom",
        ...
        "kind": "dirs",
        "get": locations.custom_clean_dirs,
        "needs_admin": False,
    },
    {
        "key": "winsxs",
        "label": "Windows component store cleanup",
        "desc": "Removes superseded update components via DISM. Needs admin; can take a while.",
        "kind": "command",
        "needs_admin": True,
        "run": lambda log: winapi.run_maintenance_command(
            config.DISM_COMPONENT_CLEANUP
        ),
    },
    {
        "key": "hiberfil",
    ...
    },
    {
        ...
        "kind": "command",
        "needs_admin": True,
        "estimate": _windows_old_estimate,
